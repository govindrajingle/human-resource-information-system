            ...
            <div class="container mt-4">
                <!-- Page Heading -->
                      ...
                      <div class="row">
                       ...
                       <input type="text" class="form-control" id="normal_emp_profile_mname" placeholder="Middle name" readonly="readonly" required>
                                                                                  <div class="invalid-tooltip">
                                      ...
                                      <div class="form-row">
                                        ...
                                        <div class="col-md-6 mb-3 mt-4">
                                                                                 <label for="validationTooltipGender">Blood group</label>
                                                                                   <select class="custom-select" id="normal_emp_profile_blood group" disabled="disabled" required>
                                                                                     <option value="">Choose...</option>
