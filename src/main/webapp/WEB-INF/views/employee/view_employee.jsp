          ...
          <form class="was-validated" action="employee" method="POST">
            <div class="form-row">
              ...
              <div class="col-md-6 mb-3">
                              ...
                              <input type="text" class="form-control" id="MiddleName" name="MiddleName" value="${employee.middleName}" readonly="readonly" required>
                              <div class="invalid-tooltip">
            ...
            <div class="form-row">
              ...
              <div class="col-md-6 mb-3 mt-4">
                              <label for="validationTooltipBloodGroup">Gender</label>
                                <select class="custom-select" id="blood group" name="blood group" disabled="disabled" required>
                                	<option value="${employee. blood group}" selected>${employee.blood group}</option>
